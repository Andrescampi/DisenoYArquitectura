...
public class Arquero implements Prototype{
    private String name;
    private String apariencia;
    private String hero= "Arquero";
    ...
    public Arquero(String name, String apariencia, int experiencia, int nivel, int puntos){
        this.name=name;
